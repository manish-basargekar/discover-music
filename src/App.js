...
import { FETCH_WEATHER, GET_RECOMMENDATION } from "./queries";
			...
			<div className={Style.App}>
				...
				<div className={Style.tabs}>
					...
					<button
						...
						className={`${Style.tab} ${activeTabClass}`}
					...
					<button
						className={`${Style.tab}`}
						style={{
							backgroundColor: recommended ? "#f5f5f5" : "#fcb69f",
						}}
						onClick={() => setRecommended(!recommended)}
					>
						{weather} sounds
					...
					<div className={Style.tab}>
						Featured in {data.ipApi_location_Auto.country}
					</div>
				</div>
